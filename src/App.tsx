...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'quick_publish': return <QuickPublishPage activePaperId={activePaperId} setActivePaperId={setActivePaperId} token={token} addToast={addToast} completeLabel={isAdmin ? 'Go to Global Reviews' : 'Go to Publication Records'} onComplete={() => { setActiveTab(isAdmin ? 'globalReviews' : 'records'); setActivePaperId(null); }} />;
