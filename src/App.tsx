...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'formatting': return isAdmin ? <DashboardOverview onNavigate={setActiveTab} profile={profile} setActivePaperId={setActivePaperId} /> : <FormattingEngine activePaperId={activePaperId} setActivePaperId={setActivePaperId} onNavigate={setActiveTab} />;
