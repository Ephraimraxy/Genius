  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 pb-12">
      ...
      <div className="bg-white rounded-[2rem] shadow-sm border border-slate-200 overflow-hidden">
        ...
        {/* Table Header Row */}
        <div className="hidden lg:grid grid-cols-[1fr,100px,100px,160px,160px] gap-4 px-8 py-3 bg-slate-100/50 border-b border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-500">
          <div>Manuscript</div>
            ...
            return (
              <motion.div key={paper.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  {/* DOI / ISSN */}
                  <div className="hidden lg:flex flex-col items-center justify-center w-[160px] shrink-0 text-center">
