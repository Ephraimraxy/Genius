                      ...
                      <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {[
                            ...
                            { sn: 3, name: 'Prof. I.J Kukwi', school: 'Nasarawa State University, Keffi', dept: 'Education', country: 'Nigeria' },
                            ...
                            { sn: 13, name: 'Dr. M.M Usman', school: 'Nasarawa State University', dept: 'Accounting', country: 'Nasarawa, Nigeria' },
                          ].map(m => (
